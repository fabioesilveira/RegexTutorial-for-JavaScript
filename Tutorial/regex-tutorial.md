...
Quantifiers are essential in regex as they allow you to control the number of occurrences of a pattern. Therefore, understanding how to properly use quantifiers, you are able to create more precise and flexible regular expressions throughout your studies for various use cases.
...
**Example:** Consider the following email address: `fabio_1234-@bootcamp.edu`

The local part, of the username, is `fabio_1234-`.
...
In the example, the bracket expression `[a-z0-9_\.-]` successfully matches the local part `fabio_1234-` of the email address.
...
**Example:** Consider the following email address: `fabio1234@boot-camp2023.edu`
...
**Example:** Consider the following email address: `fabio_1234.email@bootcamp123.examp.le`
...
1. `fabio.val@bootcamp.edu` **(valid)**
2. `fabio@inval@bootcamp.edu` **(invalid)**
...
**Example:** Consider the following two email addresses:
1. `fabio-val@bootcamp.com` **(valid)**
2. `fabio--val@bootcamp.com` **(valid)**
3. `fabio@val_bootcamp.com` **(invalid)**
...
**Example:** Consider the following two email addresses:
1. `fabio.val2023@bootcamp.com` **(valid)**
2. `fabio123_val@bootcamp.com` **(valid)**
3. `fabio@bootcamp7.com` **(valid)**
4. `fabio.val@2023bootcamp.com` **(invalid)**
